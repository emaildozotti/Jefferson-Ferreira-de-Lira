...
Repositorio standalone da landing page de Jefferson Lira.
...
- **Cliente:** Jefferson Lira
- **GitHub:** https://github.com/emaildozotti/Jefferson-Ferreira-de-Lira
- **Vercel:** https://jefferson-lira.vercel.app
...
```bash
git commit -m "feat: foto e video inseridos -- Jefferson Lira ao ar"
...
- O remote `origin` = `emaildozotti/Jefferson-Ferreira-de-Lira` -- nao alterar
